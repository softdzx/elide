...
public class ElideHjsonUtil {
    ...
    */
    ...
    private static JSONObject loadSchema(String confFile) throws IOException {
         ...
         * File(ClassLoader.getSystemResource(confFile).getFile()); String content = new
         * String(Files.readAllBytes(file.toPath())); return new JSONObject(new
         * JSONTokener(content));
         */
        String content = readFromJARFile(confFile);
